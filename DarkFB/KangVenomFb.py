...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mSopo jenenge sampean ? \033[1;91m: \033[1;92m")
	if nama =="":
...
def loginSC():
	...
	if username =="venom" and password =="blackhat":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/UCeO77Yw09jbr-ixCzDu5Mug')
				menu()
